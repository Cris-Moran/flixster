...
* [ ] Applied the view binding library to reduce boilerplate.
...
- Gradle kept crashing due to internet VPN issues.
- Attempting to add a radius to the images messed up image alignment.
